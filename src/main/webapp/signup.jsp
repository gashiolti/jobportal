        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form action="${pageContext.request.contextPath}/index" method="POST" id="signup-form"
                          class="signup-form">
...
<%--                            <span toggle="#password" class="zmdi zmdi-eye field-icon toggle-password"></span>--%>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="phone_nr" id="phone_nr"
                                   placeholder="Phone number"/>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="weburl" id="weburl"
                                   placeholder="Your Website URL (must include https://)"/>
                        </div>
                        <div class="form-group">
                            <textarea rows="6" class="form-input" name="description"
