...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("src/main/webapp/WEB-INF/admin/vendor/fullcalendar-3.10.0/fullcalendar"), require("jquery"));
	else if(typeof define === 'function' && define.amd)
		define(["src/main/webapp/WEB-INF/admin/vendor/fullcalendar-3.10.0/fullcalendar", "jquery"], factory);
	else if(typeof exports === 'object')
		factory(require("src/main/webapp/WEB-INF/admin/vendor/fullcalendar-3.10.0/fullcalendar"), require("jquery"));
	else
