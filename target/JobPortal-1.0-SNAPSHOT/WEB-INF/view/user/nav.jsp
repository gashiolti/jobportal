                            ...
                            <div class="main-menu">
                                <nav class="d-none d-lg-block">
                                    <ul id="navigation">
                                        ...
                                        <li><a href="${pageContext.request.contextPath}/dispatch?page=joblist&userid=${userid}">
                                            Find a Jobs </a></li>
                                        <li><a href="#">Page</a>
                                            <ul class="submenu">
                                                <li><a
                                        ...
                                        <li><a href="${pageContext.request.contextPath}/dispatch?page=contact">Contact</a></li>
                                    </ul>
                                </nav>
                            </div>
                            <!-- Header-btn -->
